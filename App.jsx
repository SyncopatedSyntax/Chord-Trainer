...
else if(/^[A-G]?m/.test(s))cat=‘cowboy’;
else cat=‘cowboy’;
return{
id:`prog_${s}_${c.rn}`,
name:s,
...
style.textContent=`*{-webkit-tap-highlight-color:transparent;box-sizing:border-box;} button,a,label,[role=button]{touch-action:manipulation;-webkit-user-select:none;user-select:none;} body{overscroll-behavior-y:none;-webkit-overflow-scrolling:touch;} input,textarea,select{font-size:16px!important;}`;
